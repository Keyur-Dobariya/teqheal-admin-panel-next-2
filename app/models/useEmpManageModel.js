...
import {ApprovalStatus, BloodGroup, Gender, selectOptions, Technology, UserRole} from "../utils/enum";
...
export function useEmpManageModel({
                                      roles,
                                      selectedRecord,
        ...
        if (isModelOpen) {
            if (isEditing && selectedRecord) {
                ...
                const defaultValues = {
                    ...
                    role: roles[1]?._id ?? roles[0]?._id ?? null,
                    isActive: true,
                };
            ...
            >
                ...
                >
                    <Form
                        form={form}
                        layout="vertical"
                        onFinish={handleAddUpdateUserApi}
                                ...
                                <Row gutter={[16, 16]} justify="space-between" align="middle">
                                    ...
                                    <Col xs={24} md={18} lg={15}>
                                        <div className="flex flex-col gap-4">
                                            <Row gutter={[16, 16]}>
                                                <Col xs={24} sm={12}>
                                                    <Input addonBefore={<Linkedin/>}
                                                           placeholder={appString.profileUrl}/>
                                                </Col>
                                                <Col xs={24} sm={12}>
                                                    <Input addonBefore={<XOutlined/>}
                                                           placeholder={appString.profileUrl}/>
                                                </Col>
                                            </Row>
                                            <Row gutter={[16, 16]}>
                                    ...
                                    <Row gutter={16}>
                                        <Col xs={24} sm={8}>
                                            <Form.Item name={appKeys.approvalStatus} label={appString.approvalStatus}>
                                                <Select
                                                    options={Object.values(ApprovalStatus).map(v => ({
                                                        label: v,
                                                        value: v
                                                    }))}
                                                />
                                    ...
                                    <Col xs={24} sm={7}>
                                        <Form.Item name={appKeys.mobileNumber} label={appString.mobileNumber}
                                                   rules={[
                                                       {
                                                           required: true,
                                                           message: `${appString.mobileNumber} is required`
                                                       },
                                                       {
                                                           type: "tel",
                                                           message: `Enter a valid ${appString.mobileNumber.toLowerCase()}`
                                                       },
                                                   ]}
                                        >
                                    ...
                                    <Col xs={24} sm={7}>
                                        <Form.Item
                                            ...
                                            rules={[
                                                {
                                                    required: true,
                                                    message: `${appString.emergencyContactNo} is required`
                                                },
                                                {
                                                    type: "tel",
                                                    message: `Enter a valid ${appString.emergencyContactNo.toLowerCase()}`
                                                },
                                            ]}
                                        >
                                            <Input
                                    ...
                                    <Col xs={24} sm={10}>
                                        <Form.Item
                                            ...
                                            rules={[
                                                ...
                                                {
                                                    type: "email",
                                                    message: `Enter a valid ${appString.emailAddress.toLowerCase()}`
                                                },
                                            ]}
                                        >
                                            <Input
                                    ...
                                    <Col xs={12} sm={6}>
                                        <Form.Item
                                            ...
                                            rules={[
                                                ...
                                                {
                                                    type: "tel",
                                                    message: `Enter a valid ${appString.pincode.toLowerCase()}`
                                                },
                                            ]}
                                        >
                                            <Input
    ...
    return {showModel, hideModel, UserManageModel};
}
