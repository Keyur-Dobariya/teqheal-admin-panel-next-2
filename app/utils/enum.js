...
export const eventTypeMenuList = [
    {label: eventTypeLabels.birthday, value: "birthday"},
    {label: eventTypeLabels.holiday, value: "holiday"},
    {label: eventTypeLabels.officeEvent, value: "officeEvent"},
    {label: eventTypeLabels.workingSaturday, value: "workingSaturday"},
    {label: eventTypeLabels.offSaturday, value: "offSaturday"},
    {label: eventTypeLabels.festival, value: "festival"},
    {label: eventTypeLabels.nationalHoliday, value: "nationalHoliday"},
    {label: eventTypeLabels.exam, value: "exam"},
    {label: eventTypeLabels.meeting, value: "meeting"},
    {label: eventTypeLabels.anniversary, value: "anniversary"},
    {label: eventTypeLabels.importantDay, value: "importantDay"},
    {label: eventTypeLabels.newYear, value: "newYear"},
    {label: eventTypeLabels.makarSankranti, value: "makarSankranti"},
    {label: eventTypeLabels.republicDay, value: "republicDay"},
    {label: eventTypeLabels.vasantPanchami, value: "vasantPanchami"},
    {label: eventTypeLabels.mahaShivratri, value: "mahaShivratri"},
    {label: eventTypeLabels.holi, value: "holi"},
    {label: eventTypeLabels.chetichand, value: "chetichand"},
    {label: eventTypeLabels.eidUlFitr, value: "eidUlFitr"},
    {label: eventTypeLabels.ramNavami, value: "ramNavami"},
    {label: eventTypeLabels.mahavirJayanti, value: "mahavirJayanti"},
    {label: eventTypeLabels.ambedkarJayanti, value: "ambedkarJayanti"},
    {label: eventTypeLabels.goodFriday, value: "goodFriday"},
    {label: eventTypeLabels.parshuramJayanti, value: "parshuramJayanti"},
    {label: eventTypeLabels.eidUlAdha, value: "eidUlAdha"},
    {label: eventTypeLabels.muharram, value: "muharram"},
    {label: eventTypeLabels.rakshaBandhan, value: "rakshaBandhan"},
    {label: eventTypeLabels.independenceDay, value: "independenceDay"},
    {label: eventTypeLabels.parsiNewYear, value: "parsiNewYear"},
    {label: eventTypeLabels.janmashtami, value: "janmashtami"},
    {label: eventTypeLabels.eidEMilad, value: "eidEMilad"},
    {label: eventTypeLabels.gandhiJayanti, value: "gandhiJayanti"},
    {label: eventTypeLabels.dussehra, value: "dussehra"},
    {label: eventTypeLabels.diwali, value: "diwali"},
    {label: eventTypeLabels.vikramSamvatNewYear, value: "vikramSamvatNewYear"},
    {label: eventTypeLabels.bhaiBij, value: "bhaiBij"},
    {label: eventTypeLabels.sardarPatelJayanti, value: "sardarPatelJayanti"},
    {label: eventTypeLabels.guruNanakJayanti, value: "guruNanakJayanti"},
    {label: eventTypeLabels.devDeepawali, value: "devDeepawali"},
    {label: eventTypeLabels.qutubFestival, value: "qutubFestival"},
    {label: eventTypeLabels.hornbillFestival, value: "hornbillFestival"},
    {label: eventTypeLabels.galdanNamchot, value: "galdanNamchot"},
    {label: eventTypeLabels.hanukkah, value: "hanukkah"},
    {label: eventTypeLabels.christmas, value: "christmas"},
    {label: eventTypeLabels.tulsiPujanDiwas, value: "tulsiPujanDiwas"},
    {label: eventTypeLabels.losarFestival, value: "losarFestival"},
    {label: eventTypeLabels.newYearsEve, value: "newYearsEve"},
    {label: eventTypeLabels.teacherDay, value: "teacherDay"},
];
